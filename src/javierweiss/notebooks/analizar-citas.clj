...
(ns analizar-citas
  (:require [nextjournal.clerk :as clerk]
            ...
            [clojure.string :refer [capitalize join ends-with? starts-with? lower-case upper-case]])
...
;; Sin embargo, en las listas no operan igual que en los vectores. En las listas los elementos siempre son
...
;; Los conjuntos se estructuras de datos que se asemejan a los conjuntos formalmente definidos en las matemáticas.
;; Por ahora nos conformamos con apuntar algo básico: los conjuntos no tienen elementos repetidos y no ordenan sus 
;; elementos. Podemos crear un conjunto utilizando el literal #{}
...
;; Con _conj_ podemos agregar elementos a nuestro conjunto (noten que los elementos no se mantienen ordenados)
...
(clerk/html [:div {:style {:background-color :#E6E6E6 :padding :1rem}}
             ...
             [:p "En resumidas cuentas, es importante siempre tener en cuenta cuál es el tipo de dato que nos devuelve la función. Esta información la podemos encontrar 
                  a menudo en la documentación de la función en cuestión, de lo contrario, podemos como hemos ahora pasarle la expresión en cuestión a la función "
              [:b "type."]]])
...
;; Recordemos que nuestras estructuras de datos son inmutables, cualquier función que le apliquemos no afectará la 
...
(def imagen (io/file "resources/temas de hoy.jpg"))
...
(-> (io/file "resources/best_shuffle.png")
    (iniciar-ocr "eng"))
